...
<b>Совет:</b> Включи уведомления, чтобы не забывать заполнять дневник!"""
    ...
    # Help menu text for Reply button
    HELP_MENU_TEXT = """❓ <b>Помощь по кнопкам бота</b>

📊 <b>Моя неделя</b> — выбери день и заполни оценки по 4 категориям (здоровье, спорт, учёба, отдых) + заметку.

🚀 <b>Открыть Skill Tracer</b> — запускает мини-приложение в Telegram для расширенного ввода.

⚙️ <b>Настройки</b> — измени имя, email и уведомления.

❓ <b>Помощь</b> — эта справка.

Всё просто! Начни с кнопки <b>📊 Моя неделя</b>."""
...
Выбери, что хочешь изменить:"""
    ...
    # Journal
    SELECT_DAY = "Выберите день для заполнения или просмотра:"
    ENTRY_PROMPT = "Опиши свой день (можно прикрепить фото/видео/голос):"
    ENTRY_SAVED = "✅ Запись сохранена!"
    ENTRY_COMMENT_RECEIVED = "📝 Заметка получена. Не забудь нажать ✅ Сохранить запись!"
    ENTRY_MEDIA_RECEIVED = "📎 Медиа получено. Не забудь нажать ✅ Сохранить запись!"
...
class BotButtons:
    ...
    MY_WEEK = "📊 Моя неделя"
    WEEK_STATUS = "📅 Моя неделя"  # legacy alias
    SETTINGS = "⚙️ Настройки"
    HELP = "❓ Помощь"
    BACK_TO_MENU = "⬅️ Назад в меню"
    BACK_TO_DAYS = "⬅️ Назад к выбору дня"
